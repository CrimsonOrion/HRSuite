...
public class ServiceListReportViewModel : BindableBase, INavigationAware
{
    ...
    #region Service List Report View Properties

    public static string Title => "Service List Report";
    ...
    public ServiceListReportViewModel(IDialogCoordinator dialogCoordinator, IErrorHandler errorHandler, IDataProcessor dataProcessor, IWorksheet worksheet)
    {
    ...
    private async void CreateReport()
    {
        ...
        try
        {
            ...
            controller.SetMessage(message);
            await Task.Run(() => Thread.Sleep(1));
            await Task.Run(() => _worksheet.CreateServiceListReport(data.OrderBy(_ => _.Employee.SeniorityDate).ToList(), _isOfficeVisible, _tokensource.Token));
