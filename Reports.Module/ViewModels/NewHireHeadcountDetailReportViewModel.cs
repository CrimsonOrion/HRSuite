...
public class NewHireHeadcountDetailReportViewModel : BindableBase, INavigationAware
{
    ...
    #region New Hire Headcount Detail Report View Properties

    public static string Title => "New Hire Headcount Detail Report";
    ...
    public NewHireHeadcountDetailReportViewModel(IDialogCoordinator dialogCoordinator, IErrorHandler errorHandler, IDataProcessor dataProcessor, IWorksheet worksheet)
    {
    ...
    private async void CreateReport()
    {
        ...
        try
        {
            ...
            controller.SetMessage(message);
            await Task.Run(() => Thread.Sleep(1));
            await Task.Run(() => _worksheet.CreateEEOHeadcountDetailReport(data.ToList(), StartDate, EndDate, true, _isOfficeVisible, _tokensource.Token));
