...
public class AgeListReportViewModel : BindableBase, INavigationAware
{
    ...
    #region Age List Report View Properties

    public static string Title => "Age List Report";
    ...
    public AgeListReportViewModel(IDialogCoordinator dialogCoordinator, IErrorHandler errorHandler, IDataProcessor dataProcessor, IWorksheet worksheet)
    {
    ...
    private async void CreateReport()
    {
        ...
        try
        {
            ...
            controller.SetMessage(message);
            await Task.Run(() => Thread.Sleep(1));
            await Task.Run(() => _worksheet.CreateAgeListReport(data.ToList(), _isOfficeVisible, _tokensource.Token));
